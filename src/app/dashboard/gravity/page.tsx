  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="bg-bg-surface border border-border rounded-xl p-8 text-center relative overflow-hidden">
        ...
        <h3 className="text-lg font-bold text-text-primary mb-2">Gravity is coming in Phase 2</h3>
        <p className="text-sm text-text-secondary max-w-md mx-auto">
          The entry point for all new clients. Financial management, HR, commission tracking, cost of service delivery, and operational efficiency.
        </p>
      </div>
    </div>
  );
